...
describe('AddBankComponent', () => {
  ...
  let mockAddBankService;
  let mockDataService

  beforeEach(async(() => {

    mockAddBankService = sinon.createStubInstance(AddBankService);
    mockAddBankService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: AddBankService, useValue: mockAddBankService },
